...
Java_com_tcc_parkingmanagement_util_DeepCarUtil_InitPlateRecognizer(
...
Java_com_tcc_parkingmanagement_util_DeepCarUtil_SimpleRecognization(
        JNIEnv *env, jobject obj,
...
Java_com_tcc_parkingmanagement_util_DeepCarUtil_ReleasePlateRecognizer( JNIEnv *env, jobject obj, jlong object_re) {
