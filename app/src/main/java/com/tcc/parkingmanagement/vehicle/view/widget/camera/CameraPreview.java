package com.tcc.parkingmanagement.vehicle.view.widget.camera;
...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
        ...
        if (camera != null) {
            camera.autoFocus(new Camera.AutoFocusCallback() {
                ...
                public void onAutoFocus(boolean success, Camera camera) {
                    if (success){
                        Toast.makeText(getContext(),"定焦成功",Toast.LENGTH_SHORT).show();
                        if (onPickListener != null && count == 0){
                            count++;
                            onPickListener.onPickListener(camera);
                        }
                    }
                }
            });
    ...
    public interface OnPickListener{
         ...
         */
        void onPickListener(Camera camera);
    }
}
